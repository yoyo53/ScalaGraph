...
class DirectedGraphSpec extends UnitSpec {
  ...
  override def beforeEach(): Unit = {
   ...
   it should "check if the graph has a cycle" in {
      ...
      .addVertex(Vertex(4))
      .addEdge(DirectedEdge(Vertex(1), Vertex(2), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(3), Vertex(1), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(2), Vertex(3), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(4), Vertex(2), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(1), Vertex(4), Direction.Forward))
   ...
   it should "get the shortest paths between all pairs of vertices using Floyd-Warshall algorithm" in {
    ...
    graph = graph.addVertex(Vertex(3))
      ...
      assert(shortestPaths.get == HashMap(
        (Vertex(1, None), Vertex(3, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(3, None),  Direction.Forward)), 
        (Vertex(3, None), Vertex(2, None)) -> List(DirectedEdge(Vertex(3, None), Vertex(2, None),  Direction.Forward)), 
        (Vertex(1, None), Vertex(4, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(4, None),  Direction.Forward)), 
        (Vertex(4, None), Vertex(2, None)) -> List(DirectedEdge(Vertex(4, None), Vertex(2, None),  Direction.Forward)), 
        (Vertex(1, None), Vertex(2, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None),  Direction.Forward))))
      ...
      .addEdge(DirectedEdge(Vertex(4), Vertex(5), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(5), Vertex(6), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(2), Vertex(7), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(7), Vertex(8), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(8), Vertex(6), Direction.Forward))
      ...
      assert(shortestPaths2.get == HashMap(
        (Vertex(1, None), Vertex(3, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward)), 
        (Vertex(2, None), Vertex(4, None)) -> List(DirectedEdge(Vertex(2, None), Vertex(3, None),  Direction.Forward), DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward)), 
        (Vertex(3, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward), DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward), DirectedEdge(Vertex(5, None), Vertex(6, None), Direction.Forward)), 
        (Vertex(1, None), Vertex(8, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward)), 
        (Vertex(3, None), Vertex(4, None)) -> List(DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward)), 
        (Vertex(7, None), Vertex(8, None)) -> List(DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward)), 
        (Vertex(1, None), Vertex(4, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward), DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward)), 
        (Vertex(2, None), Vertex(8, None)) -> List(DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward)), 
        (Vertex(2, None), Vertex(5, None)) -> List(DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward), DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward), DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward)), 
        (Vertex(2, None), Vertex(7, None)) -> List(DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward)), 
        (Vertex(4, None), Vertex(5, None)) -> List(DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward)), 
        (Vertex(1, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward), DirectedEdge(Vertex(8, None), Vertex(6, None), Direction.Forward)), 
        (Vertex(4, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward), DirectedEdge(Vertex(5, None), Vertex(6, None), Direction.Forward)), 
        (Vertex(1, None), Vertex(2, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward)), 
        (Vertex(2, None), Vertex(3, None)) -> List(DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward)), 
        (Vertex(5, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(5, None), Vertex(6, None), Direction.Forward)), 
        (Vertex(3, None), Vertex(5, None)) -> List(DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward), DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward)), 
        (Vertex(1, None), Vertex(7, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward)), 
        (Vertex(1, None), Vertex(5, None)) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward), DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward), DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward)), 
        (Vertex(2, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward), DirectedEdge(Vertex(8, None), Vertex(6, None), Direction.Forward)), 
        (Vertex(7, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward), DirectedEdge(Vertex(8, None), Vertex(6, None), Direction.Forward)), 
        (Vertex(8, None), Vertex(6, None)) -> List(DirectedEdge(Vertex(8, None), Vertex(6, None), Direction.Forward))))
    }
   ...
   it should "get the shortest path between two vertices using Floyd-Warshall algorithm" in {
    ...
    graph = graph.addVertex(Vertex(3))
      ...
      .addEdge(DirectedEdge(Vertex(2), Vertex(3), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(3), Vertex(4), Direction.Forward))
      .addEdge(DirectedEdge(Vertex(2), Vertex(4), Direction.Forward))
      ...
      assert(shortestPath.get == List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(4, None), Direction.Forward)))
      ...
      assert(shortestPath2.get == List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward), DirectedEdge(Vertex(8, None), Vertex(6, None), Direction.Forward)))
    }
   ...
   it should "get the shortest paths from a source vertex to all other vertices using Dijkstra's algorithm" in {
    ...
    graph = graph.addVertex(Vertex(3))
      ...
      assert(shortestPaths.get == HashMap(
        Vertex(1, None) -> List(), 
        Vertex(2, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward)), 
        Vertex(3, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward)), 
        Vertex(4, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(4, None), Direction.Forward)))
      )
      ...
      assert(shortestPaths2.get == HashMap(
      Vertex(6, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward), DirectedEdge(Vertex(8, None), Vertex(6, None), Direction.Forward)), 
      Vertex(8, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward), DirectedEdge(Vertex(7, None), Vertex(8, None), Direction.Forward)), 
      Vertex(1, None) -> List(), 
      Vertex(4, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward), DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward)), 
      Vertex(7, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(7, None), Direction.Forward)), 
      Vertex(5, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward), DirectedEdge(Vertex(3, None), Vertex(4, None), Direction.Forward), DirectedEdge(Vertex(4, None), Vertex(5, None), Direction.Forward)), 
      Vertex(3, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward), DirectedEdge(Vertex(2, None), Vertex(3, None), Direction.Forward)), 
      Vertex(2, None) -> List(DirectedEdge(Vertex(1, None), Vertex(2, None), Direction.Forward))))
   ...
   it should "get the shortest path from a source vertex to a destination vertex using Dijkstra's algorithm" in {
    ...
    it should "encode and decode the graph to JSON" in {
      ...
      assert(json != null)
      assert(json == """{"DirectedGraph":{"vertices":[{"id":1},{"id":2},{"id":3},{"id":4}],"edges":[{"v1":{"id":1},"v2":{"id":2},"direction":"Forward"},{"v1":{"id":2},"v2":{"id":3},"direction":"Forward"},{"v1":{"id":3},"v2":{"id":4},"direction":"Forward"},{"v1":{"id":2},"v2":{"id":4},"direction":"Forward"}]}}""")

      // Decode the JSON to a graph
      val decodedGraph = json.fromJson[DirectedGraph[Float]].getOrElse(DirectedGraph[Number]())
      ...
      assert(decodedGraph.getEdges.contains(DirectedEdge(Vertex(2), Vertex(3), Direction.Forward)))
      assert(decodedGraph.getEdges.contains(DirectedEdge(Vertex(3), Vertex(4), Direction.Forward)))
      assert(decodedGraph.getEdges.contains(DirectedEdge(Vertex(2), Vertex(4), Direction.Forward)))
      ...
      // Another more complex graph with 6 vertices 
        ...
        // Check if the JSON is correct
        assert(json2 != null)
        assert(json2 == """{"DirectedGraph":{"vertices":[{"id":6},{"id":8},{"id":1},{"id":4},{"id":7},{"id":5},{"id":3},{"id":2}],"edges":[{"v1":{"id":7},"v2":{"id":8},"direction":"Forward"},{"v1":{"id":8},"v2":{"id":6},"direction":"Forward"},{"v1":{"id":4},"v2":{"id":5},"direction":"Forward"},{"v1":{"id":5},"v2":{"id":6},"direction":"Forward"},{"v1":{"id":2},"v2":{"id":3},"direction":"Forward"},{"v1":{"id":3},"v2":{"id":4},"direction":"Forward"},{"v1":{"id":2},"v2":{"id":7},"direction":"Forward"},{"v1":{"id":1},"v2":{"id":2},"direction":"Forward"}]}}""")
    }
