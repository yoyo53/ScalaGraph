...
class WeightedUndirectedGraphSpec extends UnitSpec {
  var graph: WeightedUndirectedGraph[Int] = _
  override def beforeEach(): Unit = {
    graph = WeightedUndirectedGraph[Int]()
      .addVertex(Vertex(1))
      .addVertex(Vertex(2))
      .addEdge(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5))
  }
  
   "WeightedUndirectedGraph" should "create a new graph with given vertices and edges" in {
    ...
    it should "be equal to another graph with the same vertices and edges" in {
      ...
      val graph2 = WeightedUndirectedGraph[Int]()
        .addVertex(Vertex(1))
        .addVertex(Vertex(2))
        .addEdge(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5))
   ...
   it should "get the set of vertices in the graph" in {
      ...
      assert(graph.getEdges.contains(WeightedUndirectedEdge(Vertex(1), Vertex(2), 5)))      
    }
   ...
   it should "set the edges in the graph" in {
      ...
      graph = graph.setEdges(Set(WeightedUndirectedEdge(Vertex(3), Vertex(4), 2)))
      ...
      // Check if the graph has the correct edges
      assert(graph.getEdges.contains(WeightedUndirectedEdge(Vertex(3), Vertex(4),  2)))      
   ...
   it should "add an edge to the graph" in {
      ...
      graph = graph.addEdge(WeightedUndirectedEdge(Vertex(3), Vertex(4), 1))
      ...
      // Check if the graph has the correct edges
      assert(graph.getEdges.contains(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5)))      
      assert(graph.getEdges.contains(WeightedUndirectedEdge(Vertex(3), Vertex(4),  1)))            
    }

   it should "remove an edge from the graph" in {

      // Remove an edge from the graph
      graph = graph.removeEdge(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5))
   ...
   it should "remove a set of edges from the graph" in {
      ...
      graph = graph.removeEdges(Set(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5)))
   ...
   it should "get the neighbors edges of a vertex" in {
      ...
      assert(graph.getNeighborsEdges(Vertex(1)).contains(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5)))      
   ...
   it should "get the predecessors edges of a vertex" in {
      ...
      assert(graph.getPredecessorsEdges(Vertex(2)).contains(WeightedUndirectedEdge(Vertex(1), Vertex(2), 5)))      
   ...
   it should "get the successors edges of a vertex" in {
      ...
      assert(graph.getSuccessorsEdges(Vertex(1)).contains(WeightedUndirectedEdge(Vertex(1), Vertex(2),  5)))      
   ...
   it should "get the adjacency matrix of the graph" in {
    ...
    graph = graph.addVertex(Vertex(3))
      .addVertex(Vertex(4))
      .addEdge(WeightedUndirectedEdge(Vertex(1), Vertex(3),  3))
      .addEdge(WeightedUndirectedEdge(Vertex(3), Vertex(2),  8))
      .addEdge(WeightedUndirectedEdge(Vertex(4), Vertex(2),  4))
      .addEdge(WeightedUndirectedEdge(Vertex(1), Vertex(4),  2))
   ...
   it should "get the incidence matrix of the graph" in {
    ...
    graph = graph.addVertex(Vertex(3))
      ...
      assert(incidenceMatrix(0) == List(0, 0, 0, 0)) //List(1, -1, 0, 0)
      assert(incidenceMatrix(1) == List(0, 0, 0, 0)) //List(1, 0, -1, 0)
      assert(incidenceMatrix(2) == List(0, 0, 0, 0)) //List(0, -1, 1, 0)
      assert(incidenceMatrix(3) == List(0, 0, 0, 0)) //List(0, -1, 0, 1)
      assert(incidenceMatrix(4) == List(0, 0, 0, 0)) //List(1, 0, 0, -1)
    }
   ...
   it should "check if the graph has a cycle" in {
      ...
      .addVertex(Vertex(3))
      .addVertex(Vertex(4))
      .addEdge(WeightedUndirectedEdge(Vertex(1), Vertex(2),  6))
      .addEdge(WeightedUndirectedEdge(Vertex(3), Vertex(1),  7))
      .addEdge(WeightedUndirectedEdge(Vertex(2), Vertex(3),  3))
      .addEdge(WeightedUndirectedEdge(Vertex(4), Vertex(2),  4))
      .addEdge(WeightedUndirectedEdge(Vertex(1), Vertex(4),  2))
   ...
   it should "get the shortest paths between all pairs of vertices using Floyd-Warshall algorithm" in {
    ...
    graph = graph.addVertex(Vertex(3))
      ...
      assert(shortestPaths.get == HashMap((Vertex(1, None), Vertex(3, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(3, None), Some(3))), (Vertex(2, None), Vertex(4, None)) -> List(WeightedUndirectedEdge(Vertex(4, None), Vertex(2, None), Some(4))), (Vertex(3, None), Vertex(2, None)) -> List(WeightedUndirectedEdge(Vertex(3, None), Vertex(2, None), Some(8))), (Vertex(3, None), Vertex(4, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(3, None), Some(3)), WeightedUndirectedEdge(Vertex(1, None), Vertex(4, None), Some(2))), (Vertex(1, None), Vertex(4, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(4, None), Some(2))), (Vertex(4, None), Vertex(1, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(4, None), Some(2))), (Vertex(4, None), Vertex(2, None)) -> List(WeightedUndirectedEdge(Vertex(4, None), Vertex(2, None), Some(4))), (Vertex(2, None), Vertex(1, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(5))), (Vertex(1, None), Vertex(2, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(5))), (Vertex(2, None), Vertex(3, None)) -> List(WeightedUndirectedEdge(Vertex(3, None), Vertex(2, None), Some(8))), (Vertex(4, None), Vertex(3, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(4, None), Some(2)), WeightedUndirectedEdge(Vertex(1, None), Vertex(3, None), Some(3))), (Vertex(3, None), Vertex(1, None)) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(3, None), Some(3)))))
   ...
   it should "get the shortest path between two vertices using Floyd-Warshall algorithm" in {
    ...
    graph = graph.addVertex(Vertex(3))
      .addVertex(Vertex(4))
      .addEdge(WeightedUndirectedEdge(Vertex(2), Vertex(3),  3))
      .addEdge(WeightedUndirectedEdge(Vertex(3), Vertex(4),  10))
      .addEdge(WeightedUndirectedEdge(Vertex(2), Vertex(4),  7))
      ...
      assert(shortestPath.get == List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None),  Some(5)), WeightedUndirectedEdge(Vertex(2, None), Vertex(4, None),  Some(7))))
      ...
      .addEdge(WeightedUndirectedEdge(Vertex(2), Vertex(3),  3))
      .addEdge(WeightedUndirectedEdge(Vertex(3), Vertex(4),  10))
      .addEdge(WeightedUndirectedEdge(Vertex(4), Vertex(5),  9))
      .addEdge(WeightedUndirectedEdge(Vertex(5), Vertex(6),  2))
      .addEdge(WeightedUndirectedEdge(Vertex(2), Vertex(7),  1))
      .addEdge(WeightedUndirectedEdge(Vertex(7), Vertex(8),  7))
      .addEdge(WeightedUndirectedEdge(Vertex(8), Vertex(6), 4))
      ...
      assert(shortestPath2.get == List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None),  Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(7, None),  Some(1)), WeightedUndirectedEdge(Vertex(7, None), Vertex(8, None),  Some(7)), WeightedUndirectedEdge(Vertex(8, None), Vertex(6, None),  Some(4))))
    }
   ...
   it should "get the shortest paths from a source vertex to all other vertices using Dijkstra's algorithm" in {
    ...
    graph = graph.addVertex(Vertex(3))
      ...
      assert(shortestPaths.get == Map(Vertex(1, None) -> List(), Vertex(2, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None),  Some(5))), Vertex(3, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None),  Some(5)), WeightedUndirectedEdge(Vertex(2, None), Vertex(3, None),  Some(3))), Vertex(4, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None),  Some(5)), WeightedUndirectedEdge(Vertex(2, None), Vertex(4, None),  Some(7)))))
      ...
      assert(shortestPaths2.get == HashMap(Vertex(6, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(7, None), Some(1)), WeightedUndirectedEdge(Vertex(7, None), Vertex(8, None), Some(7)), WeightedUndirectedEdge(Vertex(8, None), Vertex(6, None), Some(4))), Vertex(8, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(7, None), Some(1)), WeightedUndirectedEdge(Vertex(7, None), Vertex(8, None), Some(7))), Vertex(1, None) -> List(), Vertex(4, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(7, None), Some(1)), WeightedUndirectedEdge(Vertex(7, None), Vertex(8, None), Some(7)), WeightedUndirectedEdge(Vertex(8, None), Vertex(6, None), Some(4)), WeightedUndirectedEdge(Vertex(5, None), Vertex(6, None), Some(2)), WeightedUndirectedEdge(Vertex(4, None), Vertex(5, None), Some(9))), Vertex(7, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(7, None), Some(1))), Vertex(5, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(7, None), Some(1)), WeightedUndirectedEdge(Vertex(7, None), Vertex(8, None), Some(7)), WeightedUndirectedEdge(Vertex(8, None), Vertex(6, None), Some(4)), WeightedUndirectedEdge(Vertex(5, None), Vertex(6, None), Some(2))), Vertex(3, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)), WeightedUndirectedEdge(Vertex(2, None), Vertex(3, None), Some(3))), Vertex(2, None) -> List(WeightedUndirectedEdge(Vertex(1, None), Vertex(2, None), Some(6)))))
    }
   ...
   it should "get the shortest path from a source vertex to a destination vertex using Dijkstra's algorithm" in {
    ...
    it should "encode and decode the graph to JSON" in {
      ...
      assert(json != null)
      assert(json == """{"WeightedUndirectedGraph":{"vertices":[{"id":1},{"id":2},{"id":3},{"id":4}],"edges":[{"v1":{"id":1},"v2":{"id":2},"weight":5},{"v1":{"id":2},"v2":{"id":3},"weight":3},{"v1":{"id":3},"v2":{"id":4},"weight":10},{"v1":{"id":2},"v2":{"id":4},"weight":7}]}}""")

      // Decode the JSON to a graph
      val decodedGraph = json.fromJson[WeightedUndirectedGraph[Float]].getOrElse(WeightedUndirectedGraph[Number]())
      ...
      assert(decodedGraph.getEdges.contains(WeightedUndirectedEdge(Vertex(2), Vertex(3),  3)))
      assert(decodedGraph.getEdges.contains(WeightedUndirectedEdge(Vertex(3), Vertex(4),  10)))
      assert(decodedGraph.getEdges.contains(WeightedUndirectedEdge(Vertex(2), Vertex(4),  7)))
      ...
      // Another more complex graph with 6 vertices 
        ...
        // Check if the JSON is correct
        assert(json2 != null)
        assert(json2 == """{"WeightedUndirectedGraph":{"vertices":[{"id":6},{"id":8},{"id":1},{"id":4},{"id":7},{"id":5},{"id":3},{"id":2}],"edges":[{"v1":{"id":2},"v2":{"id":3},"weight":3},{"v1":{"id":4},"v2":{"id":5},"weight":9},{"v1":{"id":2},"v2":{"id":7},"weight":1},{"v1":{"id":8},"v2":{"id":6},"weight":4},{"v1":{"id":3},"v2":{"id":4},"weight":10},{"v1":{"id":7},"v2":{"id":8},"weight":7},{"v1":{"id":5},"v2":{"id":6},"weight":2},{"v1":{"id":1},"v2":{"id":2},"weight":6}]}}""")
    }
